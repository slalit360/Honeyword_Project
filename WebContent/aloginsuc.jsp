...
<body>
  <div id="main">
	...
	<nav>
	  <div id="menubar">
        <ul id="nav">
          <li class="current"><a href="aloginsuc.jsp">Home</a></li>
          <li class="current"><a href="#">Generate Password Protection</a></li>
          <li><a href="#">Show Request</a></li>
...
%>
<form  action="aloginsuc.jsp?post=p" method="post" onsubmit="return formvalidation()">
            ...
            <table  cellpadding="3" align="center">
                ...
                <tbody>
                    <tr>
                    	...
                    	<td width="57%"><select name="userid" required>
...
%>
                    ...
                    <tr>
                        <td></td>
                        <td><input type="submit" value="Search Honeyword" />&nbsp;&nbsp;&nbsp;</td>
                    </tr>
	...
	ResultSet rs=st.executeQuery("select hn from honeyword where idd="+userid);
String hn=null;
