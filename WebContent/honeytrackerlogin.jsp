	...
	<div id="site_content">	
	  ...
	  <div id="content">
        <div class="content_item">
		  ...
		  <%
       if(request.getParameter("htl")!=null)
       {
    	   out.println("<script>alert('Wrong Username And Password Combination')</script>");
       }
       
       
       %>

<form  action="htlaction" method="post" onsubmit="return formvalidation()">
            ...
            <table  cellpadding="3" align="center" height="150px" width="150px">
                <thead>
                    <tr>
                        <th colspan="2">HoneyTracker Login </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
